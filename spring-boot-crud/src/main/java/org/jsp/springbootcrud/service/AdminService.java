...
public class AdminService {
	...
	public ResponseEntity<ResponseStructure<Admin>> saveAdmin(Admin admin)
	{
		...
		s.setMessage("Admin added successfully");
		s.setData(adminRepository.save(admin));
